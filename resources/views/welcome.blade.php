...
<head>
    ...
    {{-- add logo --}}
    <link rel="icon" type="image/png" href="{{ asset('img/favicon-32x32.png') }}">    <!-- Fonts -->
...
<body class="antialiased bg-white">
    ...
    {{-- Header --}}
    <div class="relative max-w-screen-2xl mx-auto w-full pt-2  bg-white transition duration-200 lg:bg-transparent lg:py-6">
        <div class="max-w-screen-xl mx-auto px-5 flex items-center justify-between">
            <div class="flex-1 ml-24">
                <a href="/" class="inline-flex items-center">
                    <x-application-logo style="height: 10%; width: 10%;" class=" text-green-dark fill-current" />
                </a>
            </div>
            <ul class="relative hidden lg:flex lg:items-center lg:justify-center">
                <li>
                    <x-dropdown align="right" width="48" contentClasses="py-1">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="url('https://iselcouno.com/services/billing-rates')">
                                {{ __('Billing Rates') }}
                            </x-dropdown-link>
    ...
    {{-- content --}}
    <section class="content-center text-center mt-4 h-fit">

        <h1 class="text-blue-light font-bold text-8xl font-league tracking-normal">
            The Smart Electric Meter
        </h1>
        <h2 class="text-green-dark font-bold text-6xl font-league tracking-normal -mt-11">
            for Power-saving companion
        </h2>
        <p class="-mt-1 text-black-light px-80 font-glacial font-normal text-2xl  opacity-60 tracking-tight">
        ...
        <div class="mt-5">
            <a href="{{ route('register') }}"
                ...
                <button
                    class=" bg-green-dark rounded-md py-1 px-16  active:cursor-progress text-white  hover:bg-green-700 focus:bg-green-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                    Get Started
                </button>
            </a>
        </div>
    ...
    <x-application-svg-lightning class="absolute top-28 right-96 h-20" />
    <x-application-svg-lightning class="absolute bottom-32 left-24 h-32" />
    <x-application-svg-lightning class="absolute bottom-28 right-48 h-20" />
