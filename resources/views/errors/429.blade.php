...
@section('429')
    <div class="h-screen w-screen bg-gray-100 flex items-center">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div class="max-w-md">
                <div class="text-5xl font-dark font-bold">Error 429</div>
                <p class="text-2xl md:text-3xl font-light leading-normal">Too many attemps. </p>
                <p class="mb-8">But dont worry, you can try again in 5 minutes.</p>
                <a href="{{ route('welcome') }}">
                    <button
                        class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-green-dark active:bg-green-700 hover:bg-green-900">Back
                        to homepage</button>
                </a>
            </div>
            <div class="max-w-lg">
