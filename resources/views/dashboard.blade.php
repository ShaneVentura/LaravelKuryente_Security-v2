<x-app-layout>
    ...
    <div class="flex flex-wrap border-t-2 border-black-dark border-opacity-15 ">
        <div class="w-2/3  border-l-2 border-black-dark border-opacity-80" >

            <div class="flex flex-wrap flex-col">

                <div
                    class="bg-blue-dark bg-opacity-25 h-1/6 w-full py-2  border-b-2 border-black-dark border-opacity-10 leading-tight">
                    <div class="sm:px-6 lg:px-8 flex gap-3 " x-data="{ present: 'Loading...', previous: 'Loading...', total: 'Loading...' }" x-init="setInterval(() => {
                        fetch('/dashboard/Consumption')
                ...
                <div class="bg-white bg-opacity-25 h-full w-full">
                    {{-- chartjs --}}
                    <canvas id="myChart"
                        class="
                        w-full
        ...
        <div class="border-l-2 border-black-dark border-opacity-15"></div>
        ...
        <div class="w-1/3 h-border-l-2 border-black-dark border-opacity-15 flex-1 ">
            ...
            <div class="bg-blue-dark bg-opacity-25 ">
                <div class="opacity-90 text-center text-xl font-glacial font-semibold tracking-normal py-1 ">Consumption
                    Bill</div>
            ...
            {{-- Type and Rate --}}
            <div
                class="bg-white border-t-2 border-black-dark border-opacity-10 py-1 px-10  tracking-wide items-center text-base">
                <div class="flex space-x-10">
                    <div class="flex" x-data="{ data: '{{ $meterinfo['rate']->type }}' }" x-init="data = data.charAt(0).toUpperCase() + data.slice(1)">
                        <p class="font-extrabold">Type:</p>
                        <p class="font-normal text-green-dark" x-text="data"></p>
                    </div>
            ...
            <div x-data="{ data: [], selectedYear: '' }" x-init=" data = await (async function() {
                ...
                <div class="  border-t-2 border-black-dark border-opacity-10 bg-white">
            ...
            {{-- Meter Status --}}
            <div class="bg-blue-dark bg-opacity-10 border-t-2 border-black-dark border-opacity-10">
                <div class="bg-blue-dark bg-opacity-25  border-b-2 border-black-dark border-opacity-10 ">
                    <div class="opacity-90 text-center text-xl font-glacial font-semibold tracking-normal py-1 ">
                        Meter Status</div>
                </div>
